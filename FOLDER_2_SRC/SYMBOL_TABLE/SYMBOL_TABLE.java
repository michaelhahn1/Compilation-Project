...
public class SYMBOL_TABLE
{
	...
	/****************************************************************************/
	public SYMBOL_TABLE_ENTRY enter(String name,TYPE t)
	{
		/*************************************************/
		...
		/**************************************************************************/
		SYMBOL_TABLE_ENTRY e = new SYMBOL_TABLE_ENTRY(name,t,hashValue,scope,0,next,top,top_index++);
	...
	/*************************************************/
	/* Same as find but returns only the scope value */
	/*************************************************/
	...
	public static SYMBOL_TABLE getInstance()
	{
		if (instance == null)
		{
			...
			/*IMPORTANT! Maybe ^this^ is redundant because of that dummy scope you added before*/
			/***************************************/
